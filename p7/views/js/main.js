...
var resizePizzas = function(size) {
  ...
  // Changes the value for the size of the pizza above the slider
     //  change document from (querySelector) to (getElementById)
  ...
  // Iterates through pizza elements on the page and changes their widths
    function changePizzaSizes(size) {
       // create new variables outside the loop.
        // creact naw array name is(newWidth).
        var newWidth = [];
        var randomPizzaContainer = document.getElementsByClassName("randomPizzaContainer");
        var pizzaContainer = document.getElementsByClassName("randomPizzaContainer").length;
        // this loop Iterates through pizza elements on the page
    for (var i = 0; i < pizzaContainer; i++) {
        ...
        //this loop can be changes their widths 
    for (i = 0; i < pizzaContainer; i++) {
...
// created this variable outside the loop
...
//create new variables outside the loop and change document from (querySelector) to (getElementById)
var elem
